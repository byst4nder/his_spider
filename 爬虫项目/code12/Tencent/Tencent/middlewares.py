...
class RandomUserAgentMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        spider.logger.info("Hello Middleware")
        # print('---' * 10)
...
class RandomProxyMiddleware(object):
    def __init__(self):
        ...
        #self.proxy_url = "http://145.22.142.77:6666/getproxy"
...
# requests.get(proxies = {"http" : "http://maozhaojun:ntkn0npx@47.99.65.91:16818"})

# import urllib2
# proxy_handler = urllib2.ProxyHandler({"http" : "http://maozhaojun:ntkn0npx@47.99.65.91:16818"})
