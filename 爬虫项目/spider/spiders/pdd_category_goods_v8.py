...
class PddCategoryGoodsV8Spider(scrapy.Spider):
	name  = 'pdd_category_goods_v8'
	...
	def start_requests(self):
		...
		while not is_end:
			...
			if type(detail) != int: ##当值是subject_id 时
				...
				meta = {'cat_id':cat_id,'opt_type':opt_type,'offset':offset, 'proxy':self.get_proxy_ip(False),'category':detail}
				# print(url)
