# -*- coding: utf-8 -*-
import scrapy
import json, time, sys, random, re, pyssdb, pddSign, os, datetime, setting, redis
...
goods_list = []
'''获取店铺内产品销量信息'''
class PddGoodsSalesV7Spider(scrapy.Spider):
	name = 'pdd_goods_sales_v7'
	...
	def start_requests(self):
		...
		while not is_end:
			...
			for mall_id in mall_ids:
				...
				meta = {'page':page, 'mall_id':mall_id, 'goods_list':goods_list, 'proxy':self.get_proxy_ip(False)}
