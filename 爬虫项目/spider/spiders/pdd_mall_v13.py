...
'''获取店铺信息及销量记录'''
class PddMallV13Spider(scrapy.Spider):
	name = 'pdd_mall_v13'
	...
	def start_requests(self):
		...
		while not is_end:
			...
			for mall_id in mall_ids:
				...
				yield scrapy.Request('http://apiv4.yangkeduo.com/mall/'+str(mall_id)+'/info?query_mall_favorite_coupon=true', meta=meta,callback=self.parse, headers=headers, dont_filter=True, errback=self.errback_httpbin)
			time.sleep(1)
