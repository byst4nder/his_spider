...
class PddMallV10Spider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        while not is_end:
            ...
            for mall_id in mall_ids:
                ...
                yield scrapy.Request('http://mobile.yangkeduo.com/mall_page.html?mall_id=' + str(mall_id), meta=meta,
    ...
    def parse(self, response):
        ...
        # print('success------------------------------end:', mall_info['mallID'])
    ...
    def make_headers(self):
        ...
        headers = {
            ...
            # "Referer":"Android",
            # "Connection":"keep-alive",
            "Cookie": '_nano_fp=XpdYX0gJlpgon0dxl9_Vfj_vkXR1TNT9PuWUpMqq; api_uid=' + str(
                self.ssdb_client.get('pdd_api_uid')),
    ...
    def get_proxy_ip(self, refresh):
        if not refresh and self.proxy_count < 50:
