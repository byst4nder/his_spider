...
class PddKeywordGoodsV7RankRetrySpider(scrapy.Spider):
	handle_httpstatus_list = [403]
	FEED_EXPORT_ENCODING = 'utf-8'
	name = 'pdd_keyword_goods_v7_rank_retry'
	...
	def start_requests(self):
		...
		while search:
			...
			for hot_keyword in hot_keywords:
				...
				meta = {'page': page, 'keyword': hot_keyword, 'sort': sort, 'p_time': detail['p_time']}
	...
	def make_headers(self, keyword):
		headers = {
			...
			"Cookie": "api_uid=",
			'VerifyAuthToken': '3zmTvyPT9P1gf4DR05dqaA'
		}
		return headers
