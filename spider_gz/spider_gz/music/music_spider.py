...
class Music:
    def __init__(self):
        ...
        self.key = 'music_v1'
        self.key_queue = 'music_queue'
        self.url = 'http://www.yue365.com/bang/fenlei.shtml'
    ...
    def request(self):
        ...
        try:
            ...
            soup1 = soup.find_all('div', class_="right")
            if soup1:
    ...
    def request_music(self, url):
        ...
        try:
            ...
            items = soup.find_all('div', class_="song")
        except Exception as e:
    ...
    def save_data(self):
        title_list = self.redis_client.hkeys(self.key)
